      ...
      <div className="mx-auto max-w-2xl px-6 pb-28 pt-24 sm:px-10 sm:pt-28">
        ...
        {sections.map((s, si) => {
          /* "1. Careers look like..." splits into a hanging numeral and
             the title itself. Both are Cormorant at regular weight, so
             they read as one lockup rather than two competing objects —
             the numeral carries the accent colour and the scale, the
             title carries the authority. A hairline above each opener
             gives the reader an actual chapter turn. */
                  ...
                  {numbered ? (
                    ...
                    <h2 className="flex items-start gap-x-4 sm:gap-x-5">
                      {/* Baseline alignment puts a 78px numeral's shoulders
                          ...
                          and the difference of those two is the drop. It is
                          written in calc so it tracks both clamps down to
                          mobile rather than holding at one width. */}
                      <span
